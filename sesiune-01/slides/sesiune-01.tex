...
%//TODO: code examples: trap_init (zic de registru)
%// la page table zic de CR3
%// la init_IRQ arat alea cu IN/OUT
%//kernel thread si cpu idle code??
...
%TODO: cursul ala de startup, site opengrok, lxr, init kernel doc
